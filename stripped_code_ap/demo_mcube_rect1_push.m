...
% h5create('a=0_v=10_i=0.000_s=0.000_t=0.698_matlab.h5','/tip_pose',size(tip_pose))
% h5write('a=0_v=10_i=0.000_s=0.000_t=0.698_matlab.h5','/tip_pose',tip_pose)
% h5create('a=0_v=10_i=0.000_s=0.000_t=0.698_matlab.h5','/object_pose',size(object_pose))
% h5write('a=0_v=10_i=0.000_s=0.000_t=0.698_matlab.h5','/object_pose',object_pose)
...
dt = 1 / 180.0;  
starttime = 0.0;
endtime =size(tip_pose,1) * dt;
timearray = [0:dt:endtime-dt];
length(timearray)
plot(timearray, object_pose(:,1)*100)
title('tip position raw data matlab')

h5disp('a=0_v=10_i=0.000_s=0.000_t=0.698_matlab.h5')
h5info('a=0_v=10_i=0.000_s=0.000_t=0.698_matlab.h5')
tip_radius = 0.00475;
